...
export WORK_DIR=$HOME/ML/mnist/caffe #working dir

MOD_NUM=6   # model number
...
if [ ! -d $HOME/ML/mnist/input/mnist_jpg/ ]; then
	...
	python $WORK_DIR/code/1_write_mnist_images.py
...
python $WORK_DIR/code/4_training.py -s $WORK_DIR/models/$NET/m$MOD_NUM/solver_$MOD_NUM\_$NET.prototxt -l caffe/models/$NET/m$MOD_NUM/logfile_$MOD_NUM\_$NET.log
