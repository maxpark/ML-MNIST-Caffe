...
# ##################################################################################################
# USAGE
# python ./code/6_make_predictions.py -d ./models/LeNet/m3/deploy_3_LeNet.prototxt -w ./models/LeNet/m3/snapshot_3_LeNet__iter_40000.caffemodel

# it computes the prediction accuracy for the CNN trainined on MNIST by using a 1000 JPEG images in
...
# mean file for MNIST training dataset
MEAN_FILE    = config.MEAN_FILE                         # i.e. "/home/ML/mnist/input/mean.binaryproto"
# test dataset
#TEST_DATASET = config.MNIST_JPG_DIR + "/test/*.jpg" # i.e. "/home/ML/mnist/input/mnist_jpg/test/*.jpg"
TEST_DATASET = config.MNIST_JPG_DIR + "/val/*/*.jpg" # i.e. "/home/ML/mnist/input/mnist_jpg/test/*.jpg"
